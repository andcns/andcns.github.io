(function () {
  const ROOT = "./assets/images/gladiator/";
  const media = {
    hero: `${ROOT}hero.webp`,
    ...
    demo: "./assets/video/gladiator/demo.mp4"
  };
    ...
    <div class="ga-case-study">
      <section class="ga-section" aria-labelledby="ga-overview-title">
        <header class="ga-section-head">
          ...
          <p>Gladiator Ascendant was a team-made 2.5D arena prototype created for the 2026 Global Game Jam theme “Mask”. My focus was the visual direction, character production and a reusable art workflow that could hold together under jam constraints.</p>
        </header>
        <div class="ga-reel">
      ...
      <section class="ga-section" aria-labelledby="ga-arena-title">
        ...
        <div class="ga-gallery">
          ${figure(media.arena1, "Gladiator Ascendant arena duel in Unity", "Arena composition / player and enemy spacing")}
          ${figure(media.arena2, "Gladiator Ascendant action scene in Unity", "Combat readability during movement")}
          ${figure(media.arena3, "Gladiator Ascendant shield encounter in Unity", "Character silhouettes against the arena")}
        </div>
      </section>
      ...
      <section class="ga-section" aria-labelledby="ga-character-title">
        ...
        <div class="ga-character-feature">
          ${figure(media.all, "Four Gladiator Ascendant character variants", "Final character set / shared production base")}
        ...
        <div class="ga-wire-grid">
          ${figure(media.wfFront, "Front wireframes of Gladiator Ascendant character variants", "Front topology comparison")}
          ${figure(media.wfBack, "Back wireframes of Gladiator Ascendant character variants", "Back topology comparison")}
        </div>
      </section>
      ...
      <section class="ga-section" aria-labelledby="ga-boss-title">
        ...
        <div class="ga-character-feature">
          ${figure(media.hero, "Masked Gladiator Ascendant boss character", "Masked boss / PSX-inspired character treatment")}
          <article class="ga-copy-card">
  ...
  function syncDialog() {
    ...
    if (isGladiator) {
      hero.innerHTML = zoomImage(media.hero, "Masked Gladiator Ascendant boss character", "ga-hero-image");
